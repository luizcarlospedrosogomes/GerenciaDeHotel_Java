...
public class ListaReserva extends javax.swing.JDialog {

    /** Creates new form ListaReserva */
    public ListaReserva(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        tela();
    }
   ...
   jTable1.addMouseListener(new MouseAdapter() {
    public void mousePressed(MouseEvent me) {
        ...
        if (me.getClickCount() == 2) {
            ...
            formReserva.getCodigoTable(String.valueOf(jTable1.getValueAt(row, 0)), String.valueOf(jTable1.getValueAt(row, 1)), String.valueOf(jTable1.getValueAt(row, 2)), String.valueOf(jTable1.getValueAt(row, 3)),String.valueOf(jTable1.getValueAt(row, 5)), String.valueOf(jTable1.getValueAt(row, 4)));
            formReserva.setVisible(true);
            formReserva.setLocationRelativeTo(null);
            formReserva.setDefaultCloseOperation(formReserva.DISPOSE_ON_CLOSE);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ListaReserva dialog = new ListaReserva(new javax.swing.JFrame(), true);
